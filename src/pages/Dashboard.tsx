...
const Dashboard = () => {
    ...
    return (
        ...
        >
            ...
            <section
                ref={heroRef}
                className="pt-16 pb-20 px-5 md:px-10 lg:px-16"
                aria-labelledby="dashboard-title"
            ...
            >
                <div className="max-w-6xl mx-auto">
                    <h2
                        ...
                        className="text-2xl md:text-3xl font-bold text-gray-800 mb-10 text-center"
                    >
                        Quick Actions
                    </h2>
                    ...
                    >
                        {[
                            ...
                            >
                                <div
                                    className="w-12 h-12 rounded-full bg-indigo-100 flex items-center justify-center text-indigo-600"
                                    aria-hidden="true"
                                >
                                    {i + 1}
                                </div>
