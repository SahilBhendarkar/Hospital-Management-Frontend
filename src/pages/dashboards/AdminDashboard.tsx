...
return (
    ...
    >
        ...
        <section className="pt-16 pb-12 px-5 md:px-10 lg:px-16">
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {stats.map((stat, i) => (
                    <StatCard
                        ...
                        title={stat.title}
                        value={stat.value}
                        colorClass={`bg-white border-l-4 ${stat.color.replace('from-', 'border-').replace('-400', '-500')}`}
                        icon={
                ...
                <div className="lg:col-span-8 space-y-8">
                    ...
                    <div className="bg-white rounded-xl shadow-sm border p-6">
                        ...
                        <div className="overflow-x-auto">
                            <Table
                                data={appointments}
                                keyExtractor={(appt) => `${appt.patient}-${appt.time}`}
                                columns={[
                                    ...
                                    { header: "Doctor", accessor: "doctor", className: "hidden md:table-cell" },
